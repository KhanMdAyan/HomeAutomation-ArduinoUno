...
void loop() {
  ...
  if(statusCode == 200){
    ...
    String getData = "GET /update?api_key=" + String(myWriteAPIKey) + "&" + field + "=" + String(987);
    switch(countTrueCommand){
      case 0: sendCommand("AT",5,"OK");break;
      case 1: sendCommand("AT+CIPMUX",5,"OK");break;
      case 2: sendCommand('AT+CIPSTART=0,"TCP",' + HOST + "," + PORT,15,"OK");break;
      case 3: sendCommand("AR+CIPSEND=0,"+String(getData.length()+4),4,">");break;
      case 4: esp.println(getData);delay(1500);countTrueCommand++;break;
      case 5: sendCommand("AT+CIPCLOSE=0",5,"OK");break;
      case 7: Serial.print("DONEEE");delay(4000);break;
      } 
  }
//  
