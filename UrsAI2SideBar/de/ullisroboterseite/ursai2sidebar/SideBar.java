...
public class SideBar {
   ...
   /**
    * Öffnet die SideBar ohne das Ereignis BeforeOpen auszulösen (bei onOrientationChange).
    */
   ...
   */
   ...
   /**
   * Ruft die aktuelle Textfarbe der SideBar ab.
   * @return Die aktuelle Textfarbe.
   */
   ...
   */
   ...
   /**
    * Legt fest, ob die Breite des Bildes an die Breite der SideBar angepasst werden soll.
